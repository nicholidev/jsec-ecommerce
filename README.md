...
```sh
$ git clone https://github.com/nicholidev/jsec-ecommerce.git
```
...
- Have an idea or a request? Submit [an issue](https://github.com/nicholidev/jsec-ecommerce/issues) or [a pull request](https://github.com/nicholidev/jsec-ecommerce/pulls)!

### Other considerations

#### Server-side processing of payments

To see an example of how to process payments server-side with stripe, check out the [Lambda function in the snippets folder](https://github.com/nicholidev/jsec-ecommerce/blob/next/snippets/lambda.js).
